...
/*   Updated: 2021/06/17 15:05:36 by seonhjeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		can_go_there(t_window **window, float newplayerx, float newplayery)
{
	...
	px = 0.5;
	if (!is_inside_map(window, newplayerx - px, newplayery)
		|| !is_inside_map(window, newplayerx + px, newplayery)
		|| !is_inside_map(window, newplayerx, newplayery - px)
		|| !is_inside_map(window, newplayerx, newplayery + px))
		return (0);
	return (1);
}
